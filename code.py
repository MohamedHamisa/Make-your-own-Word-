...
from PyQt5.QtWidgets import *  #to import the component of the UI
from PyQt5.QtGui import *     #to import classes to handle and dealing with windows ,2D graphics ,font and text  
from PyQt5.QtPrintSupport import *  #to allow to print
...
app = QApplication(sys.argv)   #QApplication to manage the gui application's control flow and main settings 
window = BSWord()
window.show()
sys.exit(app.exec_())
